        ...
        <div class="row">
            <div class="col-md-3 footer_one_box">
                <div class="container-fluid p-0 d-flex" style="margin-left: 7.9px;">
                    <div>
                        <img src="{{ asset('images/logo_circle.png') }}" width="120px" alt="">
